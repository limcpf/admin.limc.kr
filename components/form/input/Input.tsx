...
export default function InputFactory<T>({input, setFunction, dataFunction, parentValue}: {
  input: Input<T>;
  ...
  const inputs = {
    ...
    "SELECT": <SelectInput input={input as SelectInputProp<T>} dataFunction={dataFunction} setFunction={setFunction} parentValue={parentValue} />
  }
  return (
      <div
